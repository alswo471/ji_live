...
const BASE_INSTRUMENTS: Instrument[] = [
  ...
  { symbol: 'TSLA', name: 'Tesla', assetClass: 'us-stock', currency: 'USDT', provider: 'binance-futures', providerSymbol: 'TSLAUSDT' },
  { symbol: 'NVDA', name: 'NVIDIA', assetClass: 'us-stock', currency: 'USDT', provider: 'binance-futures', providerSymbol: 'NVDAUSDT' },
  { symbol: 'AAPL', name: 'Apple', assetClass: 'us-stock', currency: 'USDT', provider: 'binance-futures', providerSymbol: 'AAPLUSDT' },
  { symbol: 'GOOGL', name: 'Alphabet', assetClass: 'us-stock', currency: 'USDT', provider: 'binance-futures', providerSymbol: 'GOOGLUSDT' },
  ...
  { symbol: 'PAXG', name: '금 연동(PAXG)', assetClass: 'metal', currency: 'USDT', provider: 'binance-spot', providerSymbol: 'PAXGUSDT' },
